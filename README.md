...
* [🔍 שלב ב': שאילתות ואילוצים](#-שלב-ב-שאילתות-ואילוצים)
  * [חלק א1': שאילתות שליפה (SELECT) כפולות](#חלק-א1-שאילתות-שליפה-select-כפולות---השוואת-יעילות)
  * [חלק א2': שאילתות שליפה (SELECT) מורכבות](#חלק-א2-שאילתות-שליפה-select-מורכבות)
...
## חלק א1': שאילתות שליפה (SELECT) כפולות - השוואת יעילות
...
## חלק א2': שאילתות שליפה (SELECT) מורכבות
